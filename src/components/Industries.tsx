import { 
  ...
  PiggyBank, FileText, Trophy, Landmark, Gun, 
  TrendingUp, Wine, Smile, Paintbrush, BarChart3,
  Shield, Bank, Calculator, Repeat2, Pill, SendHorizonal,
  Network, Home, Flask, Dice, Store, DollarSign,
  Store, Stethoscope, GemIcon, Building, UtensilsCrossed,
  ShoppingCart, Gamepad2, Sparkles, Users, Package, 
  Gift, HeadphonesIcon, Stethoscope, LineChart, 
  PlaneTakeoff, Cigarette, Globe
} from "lucide-react";
